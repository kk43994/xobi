        ...
        <div className="h-full min-h-0 rounded-2xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-dark-secondary/80 backdrop-blur-xl p-4 overflow-hidden flex flex-col gap-4">
          <div className="flex items-start justify-between gap-3 flex-wrap">
            <div className="min-w-0">
              <div className="text-gray-900 dark:text-white text-lg font-semibold">Excel 数据集</div>
              <div className="text-gray-600 dark:text-white/60 text-sm mt-1">导入 Excel → 批量改标题/改图 → 导出上架表</div>
            </div>
            <Input.Search
