...
export const getStatusColor = (project: Project): string => {
  ...
  if (status === '待生成图片') return 'text-orange-600 bg-orange-50';
  if (status === '待生成描述') return 'text-purple-600 bg-purple-50';
...
export const getProjectRoute = (project: Project): string => {
  ...
  // 项目作为“全系统留档容器”，默认进入归档页；详情页生产台仍在 /projects/:id/workbench
