...
class Project(db.Model):
    ...
    project_type = db.Column(db.String(20), nullable=False, default='ecom')  # ecom
    page_aspect_ratio = db.Column(db.String(20), nullable=False, default='3:4')
    cover_aspect_ratio = db.Column(db.String(20), nullable=False, default='1:1')
    ...
    def to_dict(self, include_pages=False):
        ...
        project_type = (self.project_type or "").strip().lower()
